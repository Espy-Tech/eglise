        ...
        showMorePhotosBtn.addEventListener('click', () => {
            ...
            modalTitle.textContent = 'Фотографии старшего поколения';
            ...
            const morePhotos = [
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+1',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+2',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+3',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+4',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+5',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+6',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+7',
                'https://placehold.co/300x200/1a1a2e/ffffff?text=Старшее+поколение+8'
            ];
            ...
            morePhotos.forEach(photoUrl => {
                ...
                img.src = photoUrl;
                img.alt = 'Фотография старшего поколения';
                img.style.width = '100%';
